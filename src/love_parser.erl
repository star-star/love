...
-file("src/love_parser.yrl", 15).

unwrap({V, _}) -> V.

unwrap({_,_,V}) -> V.

-file("d:/language/erl/ERL59~1.3/lib/parsetools-2.0.7/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
yeccpars2_1(_S, '$end', _Ss, Stack, _T, _Ts, _Tzr) ->
 {ok, hd(Stack)};
yeccpars2_1(S, add_operator, Ss, Stack, T, Ts, Tzr) ->
