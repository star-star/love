-file("/usr/local/erlang/R15B02/lib/parsetools-2.0.7/include/leexinc.hrl", 0).
...
-file("./love_scan.xrl", 17).


-file("/usr/local/erlang/R15B02/lib/parsetools-2.0.7/include/leexinc.hrl", 14).
...
yystate(3, [98|Ics], Line, Tlen, Action, Alen) ->
...
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 32 ->
    yystate(1, Ics, Line, Tlen+1, 4, Tlen);
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 36 ->
    yystate(1, Ics, Line, Tlen+1, 4, Tlen);
...
-file("./love_scan.xrl", 9).
yyaction_0(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_1/2}).
-file("./love_scan.xrl", 10).
yyaction_1(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_2/2}).
-file("./love_scan.xrl", 11).
yyaction_2(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_3/2}).
-file("./love_scan.xrl", 12).
yyaction_3(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_4/0}).
-file("./love_scan.xrl", 13).
yyaction_4() ->
     skip_token .

-file("/usr/local/erlang/R15B02/lib/parsetools-2.0.7/include/leexinc.hrl", 282).
